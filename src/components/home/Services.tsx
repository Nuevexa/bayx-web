...
const Services = () => {
  ...
  return (
    <section className="mt-10 overflow-hidden py-14 md:py-16 lg:mt-0 lg:py-24 xl:py-28">
      <div className="main-container">
        <div className="mb-11 text-center lg:mx-auto lg:mb-9 lg:max-w-[730px]">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-gray-light-v2 mb-5">Core Features</span>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <h2 className="mb-1 md:mb-3">Powerful tools built for busy garage owners.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="lg:mx-auto lg:max-w-[530px]">
              From job tracking to profitability analytics, BayX gives you everything you need to manage your shop floor.
            </p>
          </RevealAnimation>
        </div>
        {/* services cards */}
