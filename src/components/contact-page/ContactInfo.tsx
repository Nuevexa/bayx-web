...
const contactInfoItems = [
  ...
  },
  {
    ...
    icon: mailIcon,
    title: 'Email Us',
    content: 'support@bayx.io',
    link: 'mailto:support@bayx.io',
        ...
        <div className="space-y-[70px]">
          ...
          <div className="mx-auto max-w-[680px] space-y-3 text-center">
            ...
            <RevealAnimation delay={0.3}>
              <p>
                Have a question about BayX? Need help getting started? Our support team is here to help you
                get the most out of your garage management software.
              </p>
            </RevealAnimation>
          </div>
