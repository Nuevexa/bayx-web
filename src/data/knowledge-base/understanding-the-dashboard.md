...
summary: "Learn how to navigate and use the BayX Owner Dashboard - your shop's command center."
order: 2
---

## The Owner Dashboard

The BayX dashboard is designed as a "God View" - everything you need to manage your shop on a single screen without clicking through multiple menus.
...
The Quick Intake widget allows you to create new jobs instantly:
- Customer phone number
- Customer name
- Vehicle details
- Issue description

Just fill in the fields and click "Create Job" - the job is automatically added to the Intake column.
...
- Check your ELR daily - if it's below your target rate, you may be discounting too heavily
- Use the Kanban board columns to identify workflow bottlenecks
- Monitor technician efficiency to spot training opportunities
