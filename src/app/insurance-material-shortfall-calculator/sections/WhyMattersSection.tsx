                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6 text-tagline-1 text-secondary/80 dark:text-accent/80">
                        <RevealAnimation delay={0.2}>
                            <p>
                                Direct Repair Programs (DRPs) were designed to streamline the claims process, but they've evolved into a profit-extraction mechanism for insurance companies. The reality? <strong>You're being forced to work at a loss.</strong>
                            </p>
                        </RevealAnimation>
